namespace MSPAccounting.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MSPAccounting.Models.MSPAccountingContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "MSPAccounting.Models.MSPAccountingContext";
        }

        protected override void Seed(MSPAccounting.Models.MSPAccountingContext context)
        {
            ...
            states.ForEach(s => context.State.AddOrUpdate(p => p.Name, s));
            context.SaveChanges();
        }
    }
}
